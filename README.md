# 📄 PaperPortal - 논문 포털 시스템

## 📌 프로젝트 개요

**PaperPortal**은 대학원 진학을 희망하거나 학술 연구에 관심을 가진 사람들을 위한  
**연구 논문 정보 공유 플랫폼**입니다.

- 각 대학교의 학과별 연구실에서 발표된 논문 열람  
- 국내외 연구 논문 검색 기능 제공  
- 게시판을 통한 논문 관련 토론 및 질문 가능

연구 동향 파악과 커뮤니티 활동을 지원함으로써 사용자 간 지식 교류를 촉진합니다.

## 🎯 프로젝트 수행 목적

연구에 관심 있는 사용자들이  
다음과 같은 **연구 정보 접근의 어려움**을 겪고 있습니다:

- 연구실 논문 정보가 분산되어 있음  
- 국내외 논문 검색이 번거로움  
- 논문에 대한 토론 공간 부족  

이에 따라, **연구 정보 접근성 향상과 커뮤니티 형성**을 목표로 본 시스템을 개발하게 되었습니다.
